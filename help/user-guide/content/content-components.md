...
description: Entwerfen von E-Mails, Landingpages und Fragmenten mit Inhaltskomponenten - Hinzufügen von Schaltflächen, Text, Bildern, Formularen und Containern in Marketo Optimizer.
...
Verwenden Sie beim Entwerfen von Inhalten für E-Mails, Landingpages, Vorlagen und visuelle Fragmente die [!UICONTROL Inhaltskomponenten], um visuelle Design-Elemente hinzuzufügen.

Sie können beliebig viele Inhaltskomponenten in eine oder mehrere [Strukturkomponenten“ einfügen](./structure-components.md) die das Layout definieren.

## Inhaltsbibliothek

Im **[!UICONTROL Inhalt]** der Komponentenbibliothek werden die verfügbaren Inhaltskomponenten angezeigt:
...
| ![Bedingten Inhalt aktivieren](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Bedingten Inhalt aktivieren | (E-Mails und Fragmente) Aktivieren bedingter Varianten für die Komponente. |
...
Wenn die Schaltflächenkomponente auf der Arbeitsfläche angezeigt wird, enthält die Symbolleiste Optionen für die Textformatierung sowie Personalisierung und bedingte Varianten. Weitere Informationen zu den Optionen der Editor-Symbolleiste finden Sie unter [Inhaltskomponenten-Symbolleisten](#content-component-toolbars).
...
1. Wählen Sie **[!UICONTROL Target]** aus, wie das verknüpfte Ziel von der E-Mail oder Seite umgeleitet werden soll:
...
* **[!UICONTROL Asset auswählen]** - Wählen Sie diesen Typ aus, um ein Bild-Asset aus der [!DNL Marketo Optimizer] Assets-Bibliothek zu durchsuchen und auszuwählen.

  ![Durchsuchen der verfügbaren Bild-Assets](./assets/dam-assets-internal-image-selected.png){width="700" zoomable="yes"}
...
* **[!UICONTROL Medien importieren]** - Wählen Sie diesen Typ aus, um eine Datei aus Ihrem System auszuwählen und in die [!DNL Marketo Optimizer] Asset-Bibliothek zu importieren.
  ...
  ![Importieren einer Bilddatei in die Asset-Bibliothek](assets/email-designer-image-upload.png){width="450"}
...
![Bildeinstellungen](./assets/dam-assets-image-settings.png){width="250"}
...
1. Legen Sie den **[!UICONTROL Typ]** für den Link fest:
   ...
   * **[!UICONTROL Externer Link]** - Wählen Sie diesen Typ aus, um eine Standard-URL als Link-Ziel zu verwenden.
     ...
     ![Definieren eines externen Links für eine Bildkomponente](assets/component-button-link-options-external.png){width="250"}
...
1. Geben **[!UICONTROL unter]** optional einen beschreibenden Text für den Bild-Link ein.
...
1. Klicken Sie auf das _Formular_-Tool in der Komponenten-Symbolleiste oder verwenden Sie die Eigenschaften **[!UICONTROL Formular einbetten]** auf der rechten Seite, um das veröffentlichte Formular auszuwählen.
   ...
   ![Wählen Sie das veröffentlichte Formular aus](assets/content-design-add-form-properties.png){width="600"}
...
1. Wenn Sie den standardmäßigen **[!UICONTROL Follow-up-Typ]** für das Formular überschreiben möchten, ändern Sie die Einstellung entsprechend den Anforderungen für Ihre Seite oder Vorlage.
   ...
   * **[!UICONTROL Landingpage]** - Wählen Sie diese Option, um eine beliebige [!DNL Marketo Optimizer]- oder Marketo Engage-Landingpage als Folgemaßnahme auszuwählen.
   ...
   * **[!UICONTROL Externe URL]** - Wählen Sie diese Option aus, um eine beliebige URL als Folgeseite anzugeben. Nachdem der Besucher das Formular gesendet hat, lädt der Browser die vorgesehene URL.
     ...
     ![Ändern der Folgeeinstellung](assets/content-design-add-form-follow-up.png){width="280"}
