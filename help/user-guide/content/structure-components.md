...
| ![3:1-Spaltensymbol](../assets/do-not-localize/icon-design-structure-3-1.png) | [!UICONTROL 3:1 Spalte Rechts] | Ein zweispaltiger Container, der ein Verhältnis von 3:1 verwendet, um die Breite des Raums auszufüllen. Die erste Spalte (links) nimmt drei Viertel (75 %) der Breite ein, die zweite Spalte (rechts) das verbleibende Viertel (25 %). |
...
![Ziehen Sie eine Struktur auf die Arbeitsfläche](assets/content-design-add-structure.png){width="800" zoomable="yes"}
...
![Anzeigeoptionen für die Strukturkomponente](assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Spalten auf Mobilgeräten nicht stapeln](assets/structure-component-settings-stack-columns.png){width="250"}
...
![Hintergrundfarbauswahl](assets/content-components-styles-background-color.png){width="300"}
...
![Hintergrundbildeinstellungen der Strukturkomponente mit dem Asset-Wähler](assets/structure-components-background-image-settings.png){width="250"}
...
![Hintergrundbild-Platzierungs-Vorschau auf einer Strukturkomponente](assets/structure-component-styles-background-image.png){width="250"}
...
| ![Bedingten Inhalt aktivieren](../assets/do-not-localize/toolbar-button-enable-conditional-content.png){width="40"} | Bedingten Inhalt aktivieren | (E-Mails und Fragmente) Aktivieren bedingter Varianten für die Spalte. |
| ![Spalte auswählen](../assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Spalte auswählen | Wählen Sie eine Spalte anhand einer Zahl aus. Wenn die Spalte ausgewählt ist, können Sie Einstellungen und Stile anwenden. |
...
* **[!UICONTROL Hintergrundbild]** - Verschieben Sie den Umschalter, um die Einstellungen für das Hintergrundbild zu aktivieren.
  ...
  ![Einstellungen für das Spaltenhintergrundbild im Bedienfeld „Stile“](assets/structure-components-background-image-settings.png){width="250"}
...
![Spaltenkomponenten, die im visuellen Design-Bereich angezeigt werden](assets/content-design-layers-column-select.png){width="800" zoomable="yes"}
